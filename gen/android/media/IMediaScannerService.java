...
public interface IMediaScannerService extends android.os.IInterface
{
  ...
  /**
       ...
       * If specified, the caller will be notified when scanning is complete via the listener.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\media\java\android\media\IMediaScannerService.aidl:34:1:34:25")
  ...
  /**
       ...
       * If mimeType is null, then the mimeType will be inferred from the file extension.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\media\java\android\media\IMediaScannerService.aidl:44:1:44:25")
