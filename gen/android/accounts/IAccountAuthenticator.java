...
public interface IAccountAuthenticator extends android.os.IInterface
{
  ...
  /**
       * prompts the user for account information and adds the result to the IAccountManager
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:31:1:31:25")
  ...
  /**
       * prompts the user for the credentials of the account
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:38:1:38:25")
  ...
  /**
       * gets the password by either prompting the user or querying the IAccountManager
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:45:1:45:25")
  ...
  /**
       * Gets the user-visible label of the given authtoken type.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:52:1:52:25")
  ...
  /**
       * prompts the user for a new password and writes it to the IAccountManager
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:58:1:58:25")
  ...
  /**
       * launches an activity that lets the user edit and set the properties for an authenticator
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:65:1:65:25")
  ...
  /**
       ...
       * specified features
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:72:1:72:25")
  ...
  /**
       * Gets whether or not the account is allowed to be removed.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="D:\AndroidProject\AndroidSourceQ\frameworks\base\core\java\android\accounts\IAccountAuthenticator.aidl:79:1:79:25")
